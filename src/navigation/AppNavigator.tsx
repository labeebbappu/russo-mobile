    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <Stack.Navigator id={undefined} initialRouteName="Gateway">
                ...
                />
                <Stack.Screen name={'PracticeLibrary'} component={PracticeLibraryScreen} options={{
                    header: (props) => (
                        <CustomHeader {...props} title="Practice Library"/>
                    ),
                }}/>
                <Stack.Screen name={'MovieClip'} component={MovieClipScreen} options={{
                    header: (props) => (
                        <CustomHeader {...props} title="Movie Clip"/>
                    ),
                }}/>
                <Stack.Screen name={'Practice'} component={PracticeScreen} options={{
                    header: (props) => (
                        <CustomHeader {...props} title="Movie Clip"/>
                    ),
                }}/>
